			...
			<div class="card-body">
				<form action="{{ route('userUpdate', $user->id) }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input disabled value="{{ $user->email }}" class="form-control" type="text" placeholder="Masukkan Email" name="email" id="email">
					</div>

					<div class="form-group">
						<label for="name" class="form-control-label">Nama</label>
						<input value="{{ $user->name }}" class="form-control" type="text" placeholder="Masukkan Nama" name="name" id="name">
					</div>
