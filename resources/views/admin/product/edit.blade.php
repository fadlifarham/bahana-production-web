				...
				<div class="card-body">
					<form action="{{ route('adminProductUpdate', $product->id) }}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" placeholder="Masukkan Nama" name="name" id="name" value="{{ $product->name }}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control" type="number" placeholder="Masukkan Stok" name="stock" id="stock" value="{{ $product->stock }}">
						</div>

						<div class="form-group">
							<label for="photo" class="form-control-label">Foto</label>
              <div class="text-center">
                <img src="{{ asset($product->image) }}" alt="" style="max-width: 30em; max-height: 30em;">
              </div>
              <br>
...
@section('script')
  <script>
    ...
    $(document).ready(function() {
      ...
      $("#price").val(format({{ $product->price }}));
		});
