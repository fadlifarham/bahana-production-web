			...
			<div class="header-body">
				...
				<div class="row align-items-center py-4">
					<div class="col-lg-6 col-7">
						<h6 class="h2 text-white d-inline-block mb-0">Daftar Barang</h6>
					...
					<div class="col-lg-6 col-5 text-right">
						<a href="{{ route('adminProductCreate') }}" class="btn btn-sm btn-neutral">Tambah Barang</a>
					</div>
				</div>
									...
									<td>
										<div class="avatar-group">
											<a href="#" class="avatar avatar-sm rounded-circle" >
												<img alt="Image placeholder" src="{{ $product->image ? asset($product->image) : asset('assets/admin/img/default.png') }}">
											</a>
										</div>
									</td>
									<td class="text-right">
...
@section('script')
	<script>
		...
		{
			var id = id;
			var url = '{{ route("adminProductDelete", ":id") }}';
