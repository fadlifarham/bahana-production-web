      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{ Request::is('admin/orders*') ? 'active' : '' }}" href="{{ route('adminOrderIndex') }}">
                <i class="ni ni-shop text-green"></i>
                <span class="nav-link-text">Daftar Pesanan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('admin/products*') ? 'active' : '' }}" href="{{ route('adminProductIndex') }}">
                <i class="ni ni-box-2 text-red"></i>
                <span class="nav-link-text">Daftar Barang</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('users*') ? 'active' : '' }}" href="{{ route('userIndex') }}">
            ...
            @else
            <li class="nav-item">
              <a class="nav-link {{ Request::is('productIndex') ? 'active' : '' }}" href="{{ route('productIndex') }}">
                <i class="ni ni-box-2 text-blue"></i>
                <span class="nav-link-text">Barang</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('cartIndex') ? 'active' : '' }}" href="{{ route('cartIndex') }}">
                <i class="ni ni-cart text-red"></i>
                <span class="nav-link-text">
                  Keranjang 
                  <span class="badge badge-xs badge-floating badge-danger badge-circle">{{ count($carts) }}</span>
                </span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('orderIndex') ? 'active' : '' }}" href="{{ route('orderIndex') }}">
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" src="{{ Auth::user()->photo ?? asset('assets/admin/img/default.png') }}">
                  </span>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              &copy; 2020 <a href="{{ route('landing') }}" class="font-weight-bold ml-1" target="_blank">Sound System Rental</a>
            </div>
          </div>
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              <li class="nav-item">
                <a href="{{ route('landing') }}" class="nav-link" target="_blank">Sound System Rental</a>
              </li>
              <li class="nav-item">
                <a href="{{ route('landing') }}" class="nav-link" target="_blank">About Us</a>
              </li>
              {{-- <li class="nav-item">
